...
To send a Packet it's necessary to implement the [abstract class WritablePacket](https://github.com/andyalvarezdev/async-mmocore/blob/master/src/main/io.github.andyalvarezdev.mmocore/io/github/andyalvarezdevº/mmocore/WritablePacket.java)
